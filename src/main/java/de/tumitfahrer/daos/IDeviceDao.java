...
public interface IDeviceDao extends IGenericDao<Device> {
    ...
    Device getDeviceByUserId(Integer userId, String token);

    List<Device> getEnabledDevicesByUserId(Integer userId);

    List<Device> getEnabledNonExpiredDevicesByUserId(Integer userId);
